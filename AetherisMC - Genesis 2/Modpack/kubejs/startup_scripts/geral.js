...
StartupEvents.registry('item', event => {
	...
	event.create('incomplete_simple_core').displayName('Incomplete Simple Core');
	event.create('advanced_core').displayName('Advanced Core');
	event.create('incomplete_advanced_core').displayName('Incomplete Advanced Core');
...
StartupEvents.registry('block', event => {
	...
	event.create('incomplete_coke_brick').displayName("Incomplete Coke Brick");
	event.create('incomplete_blast_brick').displayName("Incomplete Blast Brick");
})
